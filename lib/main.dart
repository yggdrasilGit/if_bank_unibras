...
///
/// Descrição:
/// Este arquivo representa o ponto de entrada da aplicação Flutter.
/// Ele é responsável por inicializar o ambiente e executar o widget
/// raiz do aplicativo.
///
/// Este módulo atua como bootstrap da aplicação, iniciando toda a
/// estrutura baseada em MVVM e Clean Architecture.
///
/// Responsabilidades:
/// - Definir o entry point da aplicação
/// - Inicializar o Flutter Framework
/// - Executar o widget principal (IfBankApp)
///
/// Dependências:
/// - package:flutter/material.dart → Framework base Flutter
...
/// 1.0.0     18/03/2026  Francismar   Criação do ponto de entrada
///
/// Convenções:
...
///
/// Observações:
/// Este arquivo deve permanecer simples e não deve conter lógica
/// de negócio, regras ou configurações complexas.
///
/// Toda a configuração da aplicação deve ser delegada para:
/// - app/app.dart
///
/// Fluxo de execução:
/// main()
...
///
/// Inicializa o widget raiz do IF Bank.
void main() {
